            <aside id="projects" class="col-sm-4 col-md-3 sidebar-wrapper p_sidemenu">
                <div style="margin: 0 auto;">
                    <img src="/assets/img/avatar.jpg" alt="user_avatar" class=" center-block img-circle img-responsive" style="text-align:center;width:100px" />
                </div>
                ...
                <nav>
                    <ul class="list-group" >
                        <li class="list-group-item" style="margin:0 0 0 0">
                            <div class="periode">
                                <span class="btn  btn-circle" >P2</span>
                            </div>
                            <div style="float:left;margin-left:1em;">
                                <h4 class="active list-group-item-heading active"> <?= $project->project_name ?></h4>
