			...
			<aside class="col-xs-12 col-md-2 sidebar hidden-print" role="navigation">
			    ...
			    <ul class="nav sidebar-nav " data-spy="affix" data-offset-top="90">
					...
					<li<?= ( $this->uri->segment(1) === 'student-details'  ? ' class="active"' : '') ?>><a href="/admin/student_details"><span  class="glyphicon glyphicon-search"></span> <?= _('DÉTAIL PAR ÉLÈVE') ?></a></li>
					<li<?= ( $this->uri->segment(1) === 'students_overview'  ? ' class="active"' : '') ?>><a href="/students_overview?school_year=<?= get_school_year() ?>">
			        ...
			        <li<?= ( $this->uri->segment(2) === 'project_stats'  ? ' class="active"' : '') ?>><a href="/admin/project_stats"><span class="glyphicon glyphicon-stats"></span> <?= _('STATISTIQUES') ?></a></li>
			        ...
			        <ul class="nav dropdown-menu custom-menu">
						...
						<li<?= ( $this->uri->segment(2) === 'welcome_message'  ? ' class="active"' : '') ?>><a href="/admin/welcome_message"><?= _('ACCUEIL') ?></a></li>
						<li<?= ( $this->uri->segment(2) === 'terms'  ? ' class="active"' : '') ?>><a href="/admin/terms"><?= _('PÉRIODES') ?></a></li>
						...
						<li<?= ( $this->uri->segment(2) === 'settings'  ? ' class="active"' : '') ?>><a href="/admin/settings"><?= _('SYSTÉME') ?></a></li>
			    	</ul>
			    </li>
			  	</ul>
			</aside>
			...
			<aside class="col-xs-12 col-md-2 sidebar" >
			    ...
			    <ul class="nav nav-sidebar" data-spy="affix" data-offset-top="90">
					...
					<li<?= ( $this->uri->segment(1) === 'achievements'  ? ' class="active"' : '') ?>><a href="/achievements"><span  class="glyphicon glyphicon-education"></span> <?= _('MES BADGES') ?></a></li>
					<li<?= ( $this->uri->segment(1) === 'gallery' && $this->uri->segment(2) == 'my'  ? ' class="active"' : '') ?>><a href="/gallery/my"><span  class="glyphicon glyphicon-sunglasses"></span> <?= _('MA GALLERIE') ?></a></li>
					...
					<li<?= ( $this->uri->segment(1) === 'students_overview'  ? ' class="active"' : '') ?>><a href="/students_overview">
