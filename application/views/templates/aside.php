...
<?php else: ?>
    ...
    <aside class="col-xs-12 col-md-2 sidebar" >
        ...
        <ul class="nav nav-sidebar" data-spy="affix" data-offset-top="90">
            ...
            <li class="divider" role="separator"></li>
            <li<?= ( $this->uri->segment(2) === 'overview'  ? ' class="active"' : '') ?>><a href="/projects/overview"><span  class="glyphicon glyphicon-file"></span> <?= _('MES PROJETS') ?></a></li>
            <li<?= ( $this->uri->segment(1) === 'gallery' && $this->uri->segment(2) !== 'my' ? ' class="active"' : '') ?>><a href="/gallery"><span  class="glyphicon glyphicon-film"></span> <?= _('GALLERIE') ?></a></li>
