...
<body>
	...
	var myDropzone = new Dropzone("div#my-awesome-dropzone", {
		...
		dictInvalidFileType: 'Vérifiez le format de votre fichier. Les formats acceptés sont: <?= implode(',', $project->mime)?>',
		dictFileTooBig: 'Votre fichier est trop lourd. La taille maximale acceptée est de <?= (int) (MAX_UPLOAD_FILE_SIZE / 1000 / 1000) ?> Mo',
		init: function() {
			var myDropzone = this,
