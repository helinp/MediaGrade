      ...
      <form action="profile/update" method="post" role="form">
         ...
         <form action="profile/update" method="post" role="form">
             ...
             <tr>
                ...
                <td><input type="password" name="current_password" placeholder=" <?= LABEL_PASSWORD ?>"  /></td>
                <td></td>
             </tr>
             <tr>
             ...
             <tr>
                ...
                <td><input type="password" name="new_password_confirmation" placeholder=" Confirmation" /></td>
                <td></td>
             </tr>
             <tr class="top-line">
               <td> </td>
           ...
           <form action="/profile/upload" method="post" role="form" enctype="multipart/form-data">
             ...
             <tr>
                <td colspan="3">L'image doit être au format <em>carré</em>, JPG ou PNG et peser moins de 200Ko.</td>
    ...
    <script>
        ...
        $('#new_password').keyup(function(e) {
             ...
             if (false == enoughRegex.test($(this).val())) {
                     ...
                     $('#passstrength').html('<?= _('Mot de passe fort!')?>');
             } else if (mediumRegex.test($(this).val())) {
                     $('#passstrength').className = 'text-warning';
                     $('#passstrength').html('<?= _('Moyen mais accepté')?>');
             } else {
                     $('#passstrength').html("<?= _('Le mot de passe doit être composé d\'au moins une majuscule, une minuscule et d\'un chiffre.')?>");
             }
             return true;
        });
    </script>
