...
<main class="col-md-10">
    <form action="/uploadproject/<?= $curr_project->id ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div class="row">
            <div class = "col-xs-10">
                ...
                <div class="col-xs-5">
                    ...
                    <div class="checkbox">
                        <label>
                        <input type="checkbox" value="<?= $self_assessment->id ?>" name="data_eval_id[]" <?= (in_array($self_assessment->id, $active_self_assessments) ? 'checked' : '') ?>>
