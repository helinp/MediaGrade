<main class="col-md-12 text-left" style="">
    <h2 class=" text-left"> <?= _('Tableau de bord')?></h2>
    <hr style="margin-top:0;" />
    <div class="row">
        <div class="col-lg-4 col-md-4 col-xs-12 ">
            <div class="panel panel-danger">
                <div class="panel-heading text-center"  style="background-color:#d9534f;color:white"><?= _('À corriger')?> <span class="badge"><?= count($not_graded_projects) ?></span></div>
        ...
        <div class="col-lg-3 col-md-3 col-xs-12 ">
            <div class="panel panel-success">
                <div class="panel-heading text-center" style="background-color:#5cb85c;color:white"><?= _('Projets actifs')?>  <span class="badge"><?= count($active_projects) ?></span></div>
                <div class="panel-body text-left">
                    <table class="table table-striped small">
