            ...
            <div class = "row">
                <div class = "col-xs-10">
                    ...
                    <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-danger  pull-right" name="delete_project" value="<?= $_GET["project"] ?>"><span class="glyphicon glyphicon-remove"></span><?= $lang['DEL_PROJECT'] ?></button>
                        
                        <button type="submit" class="btn btn-warning  pull-right"  style="margin-right:0.5em;" name="disactivate_project" value="<?= $_GET["project"] ?>">
                            <span class="glyphicon glyphicon-ban-circle"></span> <?= ($curr_project["is_activated"] ? $lang['DISACTIVATE_PROJECT'] : $lang['ACTIVATE_PROJECT'])?>
                        </button>
