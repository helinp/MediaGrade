            ...
            <div class="col-md-12">       
                ...
                <?php if (isset($submitted[0]["file_path"])): ?>
                    ...
                    <?php elseif($extension == "jpg" || $extension == "png" || $extension == "gif"): ?>
                        ...
                        <img alt="<?= $user["name"] . " " . $user["last_name"] . " / " . $project["project_name"]?>" src="<?= $submitted[0]["file_path"]?>" height="300px" />
                    
                    <?php endif ?>
                <pre style="margin-top:1em"><a href="<?= $submitted[0]["file_path"]?>"><?= $submitted[0]["file_path"]?></a></pre>
                <?php else: ?>
