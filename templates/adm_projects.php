    ...
    <?php foreach ($projects as $project):?>
                    ...
                    ?>" href="projects.php?project=<?= $project["project_id"]; ?>"><?= ($project["is_activated"] ? '' : '<span class="glyphicon glyphicon-ban-circle" style="color:#d9534f"></span> ')?><b><?= $project["class"] . " / " . $project["project_name"] . "</b><br /><em>P" . $project["periode"] . " / " . $project["deadline"] ?></em><span class="glyphicon glyphicon-chevron-right pull-right"></span></a></li>
    <?php endforeach?>
            </ul>
        </nav>
    </aside>
   ...
   <main class="col-md-10">         
       ...
       <form action="projects.php" method="post" enctype="multipart/form-data" id="form">
