   <nav class="navbar navbar-default navbar-fixed-top" id="menu">
       <div class="container" <?= ($_SESSION["admin"] ? 'style="background-color:#482084;"' : '') ?>>     
           ...
           <?php if($_SESSION["admin"]):?>
                <li <?php if(isset($_GET["$title"]))  {if($title == "Créer une leçon") echo("class=\"active\"");}?>><a href="admin.php"><span class="glyphicon glyphicon-film"></span> Gérer les projets</a></li>
