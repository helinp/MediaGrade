 ...
 <div class="row">
    ...
    <?php foreach ($projects as $project):?>
                    ...
                    ?>" href="admin.php?project=<?= $project["project_id"]; ?>"><b><?= $project["class"] . " / " . $project["project_name"] . "</b><br /><em>P" . $project["periode"] . " / " . $project["deadline"] ?></em><span class="glyphicon glyphicon-chevron-right pull-right"></span></a></li>
    <?php endforeach?>
            </ul>
        </nav>
    </aside>
