   <main class="col-md-10">         
     ...
     <?php if (!empty($extension)):?>
                ...
                <?= (empty($project_data["file_name"]) ?  '' : '<p>' . $lang['SUBMITTED_FILE'] . ' <a href="' . $project_data["file_path"] . $project_data["file_name"] . '">' . $project_data["file_path"] . $project_data["file_name"] . '</a></p>') ?>
     <?php endif ?>              
            </div>
