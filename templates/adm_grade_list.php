        ...
        <nav itemscope itemtype="http://schema.org/SiteNavigationElement">
            <ul class="list-group small" itemprop="project">
                            <li><a class="list-group-item<?= (isset($_GET["class"]) ? "" : " active") ?>" href="grade.php"><?= LABEL_EVERY_CLASSES ?><span class="glyphicon glyphicon-pencil pull-right"></a></li>
                    <?php foreach($classes as $class): ?>
                        <?php if(!empty($class["class"])): ?>
                            <li><a class="list-group-item<?= (isset($_GET["class"]) ? ($_GET["class"] == $class["class"] ? " active" : "") : ""); ?>" href="grade.php?class=<?= trim($class["class"], " ")?>"><?= $class["class"]  ?><span class="glyphicon glyphicon-pencil pull-right"></a></li>
                        <?php endif ?>
                    <?php endforeach ?><li>
            </ul>
        </nav>
