...
INSERT INTO `periodes` (`id`, `name`) VALUES
(4, 'DEC'),
(5, 'JUN'),
(1, 'P1'),
(2, 'P2'),
...
INSERT INTO `projects` (`id`, `periode`, `instructions_pdf`, `instructions_txt`, `deadline`, `project_name`, `class`, `self_assessment_ids`, `assessment_type`, `skill_ids`, `extension`, `number_of_files`, `is_activated`) VALUES
